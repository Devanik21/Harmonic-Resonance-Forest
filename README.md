...
A Physics-Informed Machine Learning Framework for EEG Classification using Harmonic Wave Resonance Modeling.

> “When AI listens to the physics of the world, it unlocks unprecedented understanding.”

---

**Electronics & Communication Engineering (2026) | Researcher | Creator of HRF Framework**



[![Zenodo DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18173940.svg)](https://zenodo.org/records/18173940)
...
- 🏥 EEG-based medical diagnosis
- 😴 Sleep stage classification
- ⚡ Real-time neural signal decoding
- 📡 Noisy time-series signal analysis
...
- Fixed seed (Deterministic setup)
- Stratified 5-Fold Cross-Validation
- Standardized preprocessing pipeline
- Identical train/test splits across baselines
...
- v15.0 is the **stable benchmark release**
- v16.0 is **experimental research version**
- For reproducible results, always use v15.0
...
- Twitter: https://x.com/devanik2005  

---

## ⭐ Acknowledgments

Built independently as part of advanced research in physics-informed machine learning.

Special thanks to the open-source ML ecosystem and the scientific computing community.

---

## 🧠 Closing Statement

> HRF is not just a model — it is a unified attempt to reinterpret machine learning through the lens of physical reality.
